...
function AboutUs() {
  ...
  >
    <div className="m-2 px-5 flex flex-col justify-center items-center">
      ...
      <Slide direction="up" triggerOnce={true} delay={1400} duration={1200}>
        <p className="text-white text-justify text-md md:text-lg lg:text-xl leading-relaxed">
          ...
          >
            ...
            a student-run organization functioning for the well-being of the
            students for nearly three decades. It is headed by our most revered
            HOD Dr.M.A.Bhagyaveni, Chairperson, ECEA.
            <br />
            - ECEA strives to fulfill its objective to organize various
            activities that contribute to the academic and professional
            development of students, along with leadership qualities, teamwork,
            and other essential employability skills. It builds a platform for
            young minds to share their thoughts and aid them in becoming
